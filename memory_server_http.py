...
GEMINI_EMBEDDING_URL = "https://generativelanguage.googleapis.com/v1beta/models/Gemini Embedding 1"
...
STOP_SEQUENCES = [s.strip() for s in os.environ.get("STOP_SEQUENCES", "USER,User,user,HUMAN").split(",") if s.strip()]
